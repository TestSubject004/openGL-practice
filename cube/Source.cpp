...
void init(GLFWwindow* window) {
	renderingProgram = Utils::createShaderProgram("vertShaderCube.glsl", "fragShaderCube.glsl");
...
void display(GLFWwindow* window, double currentTime) {
	...
	//rotation and translation code by using respective matrix operations

	//moved code to build mMat to vertex shader
	...
	//build view matrix, model matrix and model-view matrix(not anymore, we just need the view matrix)
	...
	float tfLoc = glGetUniformLocation(renderingProgram, "tf"); // (the shader needs that too)
